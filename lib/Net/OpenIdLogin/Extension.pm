...
{
  $Net::OpenIdLogin::Extension::VERSION = '0.1.0';
}
...
Net::OpenIdLogin::Extension - Storage and methods for OpenId extensions, both requesting information and receiving data.
